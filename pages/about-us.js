        ...
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-lg text-gray-500">
              ...
              our experience in thousands of builds to get you not only the best
              panels, fittings, inverters and couplings at the best price, but
              also to take care of building permits, installation coordination,
              local engineering code and ordinance, licensing and insurance.
            </p>
          </div>
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
            <div className="relative z-10">
              <div className="prose prose-blue text-gray-500 mx-auto lg:max-w-none">
                <p>
                  We focus on making going solar as easy and painless for you as
                  possible. We make sure your system design will not only last
                  decades, but makes sense financially, too.
                </p>
                <ul>
                  <li>
                    We work with you to design and build the right solar system
                    for your needs.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    schedule a time for our engineers to repair your system. Oh
                    yeah, and all components are under warranty for 25 years and
                    the labor is free.
                  </li>
                </ul>
                ...
                <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                  <div className="relative text-lg text-gray-700 font-medium mt-8">
                    ...
                    <p className="relative">
                      I have dealt with a lot of customer service in my life but
                      the customer service at Sun collectors is top notch! Kate
                      was awesome and handled everything I ever asked for or
                      needed with such a great attitude. It felt like family.
                    </p>
                  </div>
                </div>
